...
async function launch(
  ...
  try {
    ...
    chmodSync(join(app, "Paseo SLP"), 0o755);
    ...
    const executablePath = options.symlink ? join(root, "paseo") : join(app, "Paseo SLP");
    if (options.symlink) symlinkSync(join(app, "Paseo SLP"), executablePath);
    ...
    const result = spawnSync(executablePath, args, {
      ...
      env: {
        ...
        APPIMAGE: "/tmp/Paseo-SLP.AppImage",
