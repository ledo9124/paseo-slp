...
export const ru: TranslationResources = {
  ...
  slp: {
    ...
    modes: {
      direct: "Прямой",
      supervised: "С супервизором",
    },
    composer: {
      title: "Режим рабочего пространства",
      hint: "Выберите, как работает это рабочее пространство, до первого сообщения.",
      selectWithValue: "Режим рабочего пространства: {{value}}",
      options: {
        single: { label: "Один агент", hint: "Один агент без ролей." },
        direct: {
          label: "Прямой",
          hint: "Вы общаетесь с Lead. Мелкую работу он делает сам, остальное поручает Peer.",
        },
        supervised: {
          label: "С супервизором",
          hint: "Вы общаетесь с Supervisor. Lead координирует инженерную работу.",
        },
      },
      locked: {
        group: "Зафиксирован, пока существует группа. Завершите группу, чтобы выбрать снова.",
        agents:
          "Зафиксирован, пока в рабочем пространстве есть агенты. Архивируйте их, чтобы выбрать снова.",
      },
      errors: {
        emptyMessage: "Напишите первое сообщение для группы.",
        toolsRequired:
          "SLP нужны инструменты Paseo. В разделе Настройки → Хосты → этот хост → Оркестрация включите инструменты Paseo и повторите попытку. Ваше сообщение сохранено.",
      },
      failed: "Хост отказался запустить группу.",
    },
    end: {
      menu: "Завершить группу SLP",
      confirmTitle: "Завершить группу SLP?",
      confirmMessage:
        "Все участники будут архивированы, и режим рабочего пространства снова станет доступен для выбора.",
      confirm: "Завершить группу",
      failed: "Хост отказался завершить группу.",
    },
    settings: {
      title: "Роли SLP",
      intro:
        "Как запускается каждая роль при старте группы. Роль без настроек использует провайдера, модель и режим разрешений, показанные в редакторе сообщений.",
      launchSection: "Запуск",
      instructionsSection: "Инструкции",
      thinkingLabel: "Размышление",
      noThinkingOptions: "У этой модели нет уровней размышления",
      bundledRoleLabel: "Инструкции {{role}}",
      bundledSharedLabel: "Общие инструкции SLP",
      bundledAlwaysApplied: "применяются всегда",
      bundledLoading: "Загрузка встроенных инструкций…",
      bundledUnavailable: "Не удалось загрузить встроенные инструкции.",
      extraPreview: "Дополнительно: {{text}}",
      bundledOnly: "Только встроенные инструкции.",
      descriptions: {
        supervisor:
          "Ваш контакт в режиме Supervised. Хранит намерение, ставит задачу Lead и отчитывается.",
        lead: "Инженерный руководитель. Читает проект, планирует, делегирует Peer и принимает результаты.",
        peer: "Одно ограниченное задание от Lead, возвращаемое как handback.",
      },
      defaultWith: "По умолчанию из редактора: {{value}}",
      defaultSummary: "Использует провайдера, модель и режим разрешений редактора сообщений.",
      hasInstructions: "Есть дополнительные инструкции.",
      edit: "Изменить",
      reset: "Использовать значения редактора",
      editTitle: "Настройки {{role}}",
      instructionsLabel: "Дополнительные инструкции",
      instructionsHint: "Добавляются к встроенным инструкциям роли.",
      instructionsPlaceholder: "Отвечайте по-русски. Отчёты не длиннее десяти строк.",
      unavailable: "Этот хост не поддерживает группы SLP.",
    },
    banner: {
      title: "{{role}} · режим {{mode}} · поколение {{number}}",
      contact: "ваш контакт в этом рабочем пространстве",
      initializing: "Группа ещё инициализируется; её первое сообщение доставляется.",
      receiptUncertain:
        "После перезапуска хост не может определить, дошло ли первое сообщение до этого агента. Проверьте историю, прежде чем отправлять снова.",
      frozen: "Эта группа заморожена: {{reason}}",
      transferSource:
        "Идёт передача: этот агент останавливается после контрольной точки и уходит, когда преемник будет готов.",
      transferCandidate: "Готовится принять работу: только чтение, пока хост его не активирует.",
      transferBlocked: "Передача заблокирована: {{reason}}. Перезапустите хост для согласования.",
      decisionWaiting:
        "Передача Lead ждёт вашего решения. Ответьте в этом чате, чтобы продолжить или отменить замену.",
      decisionSuspended:
        "Ожидание Supervisor перед заменой этого контекста. Агент остановлен до ответа.",
      decisionPending: "Замена контекста Lead ждёт решения Supervisor.",
      retired: "Поколение ушло. Работу продолжает текущий агент слота.",
      openCurrent: "Открыть текущего: {{role}}",
      mailUncertain: "Сообщений с неопределённой доставкой: {{count}}",
      mailQueued: "Сообщений в ожидании хода: {{count}}",
    },
  },
  agentPanel: {
    states: {
