...
export const ru: TranslationResources = {
  ...
  slp: {
    ...
    start: {
      menu: "Запустить группу SLP",
      title: "Запустить группу SLP",
      modeLabel: "Режим рабочего пространства",
      modeHint: {
        direct: "Вы общаетесь с Лидом. Мелкую работу он делает сам, остальное делегирует Пирам.",
        supervised: "Вы общаетесь с Супервизором. Лид координирует инженерную работу.",
      },
      providerLabel: "Провайдер",
      providerPlaceholder: "Выберите провайдера",
      providerEmpty: "Нет доступных провайдеров",
      messageLabel: "Первое сообщение",
      messagePlaceholder: "Над чем группе работать?",
      submit: "Запустить группу",
      starting: "Запуск…",
      failed: "Хост отказался запускать группу.",
    },
    banner: {
