...
export const ar: TranslationResources = {
  ...
  slp: {
    ...
    composer: {
      title: "وضع مساحة العمل",
      hint: "اختر طريقة عمل مساحة العمل هذه قبل رسالتها الأولى.",
      selectWithValue: "وضع مساحة العمل: {{value}}",
      options: {
        single: { label: "وكيل واحد", hint: "وكيل واحد بلا أدوار." },
        direct: {
          label: "مباشر",
          hint: "تتحدث مع القائد. ينجز الأعمال الصغيرة بنفسه ويفوّض الباقي إلى النظراء.",
        },
        supervised: { label: "بإشراف", hint: "تتحدث مع المشرف. ينسّق القائد العمل الهندسي." },
      },
      locked: {
        group: "ثابت ما دامت المجموعة موجودة. أنهِ المجموعة للاختيار مجددًا.",
        agents: "ثابت ما دام في مساحة العمل وكلاء. أرشفهم للاختيار مجددًا.",
      },
      errors: {
      ...
      menu: "إنهاء مجموعة SLP",
      confirmTitle: "إنهاء مجموعة SLP؟",
      confirmMessage: "تتم أرشفة كل الأعضاء ويعود وضع مساحة العمل متاحًا للاختيار.",
      confirm: "إنهاء المجموعة",
      failed: "رفض المضيف إنهاء المجموعة.",
    },
    settings: {
      title: "أدوار SLP",
      intro:
        "كيف يبدأ كل دور عند بدء مجموعة. الدور بلا إعدادات يستخدم المزوّد والنموذج ووضع الأذونات التي أظهرها المحرّر.",
      defaultSummary: "يستخدم مزوّد المحرّر ونموذجه ووضع أذوناته.",
      launchSection: "التشغيل",
      instructionsSection: "التعليمات",
      thinkingLabel: "التفكير",
      noThinkingOptions: "لا توجد مستويات تفكير لهذا النموذج",
      bundledRoleLabel: "تعليمات {{role}}",
      bundledSharedLabel: "تعليمات SLP المشتركة",
      bundledAlwaysApplied: "تُطبَّق دائمًا",
      bundledLoading: "جارٍ تحميل التعليمات المضمّنة…",
      bundledUnavailable: "تعذّر تحميل التعليمات المضمّنة.",
      extraPreview: "إضافي: {{text}}",
      bundledOnly: "التعليمات المضمّنة فقط.",
      descriptions: {
        supervisor: "جهة اتصالك في الوضع المُشرَف. يحفظ قصدك ويوجّه القائد ويعود بالتقرير.",
        lead: "المرجع الهندسي. يقرأ المشروع ويخطط ويفوّض للأقران ويقبل النتائج.",
        peer: "مهمة محدودة واحدة من القائد تُعاد كتسليم.",
      },
      defaultWith: "الافتراضي من المؤلف: {{value}}",
      hasInstructions: "يحتوي على تعليمات إضافية.",
      edit: "تعديل",
      reset: "استخدام إعدادات المحرّر",
      editTitle: "إعدادات {{role}}",
      instructionsLabel: "تعليمات إضافية",
      instructionsHint: "تُلحق بتعليمات الدور المضمّنة.",
      instructionsPlaceholder: "أجب بالعربية. اجعل التقارير أقل من عشرة أسطر.",
      unavailable: "هذا المضيف لا يدعم مجموعات SLP.",
    },
    banner: {
      ...
      decisionWaiting: "تسليم Lead ينتظر قرارك. أجب في هذه المحادثة للمتابعة أو لإلغاء الاستبدال.",
      decisionSuspended: "في انتظار Supervisor قبل استبدال هذا السياق. هذا الوكيل متوقف حتى يجيب.",
      decisionPending: "استبدال سياق Lead ينتظر قرار Supervisor.",
