...
export const zhCN: TranslationResources = {
  ...
  slp: {
    ...
    composer: {
      title: "工作区模式",
      hint: "在发送第一条消息之前选择此工作区的运作方式。",
      selectWithValue: "工作区模式：{{value}}",
      options: {
        single: { label: "单个代理", hint: "一个代理，没有角色。" },
        direct: { label: "直接", hint: "你与 Lead 对话。小任务它自己完成，其余委派给 Peer。" },
        supervised: { label: "受监督", hint: "你与 Supervisor 对话。Lead 负责协调工程工作。" },
      },
      locked: {
        group: "群组存在期间固定。结束群组后可重新选择。",
        agents: "工作区有代理期间固定。归档它们后可重新选择。",
      },
      errors: {
      ...
      menu: "结束 SLP 群组",
      confirmTitle: "结束 SLP 群组？",
      confirmMessage: "所有成员将被归档，工作区模式重新开放选择。",
      confirm: "结束群组",
      failed: "主机拒绝结束该群组。",
    },
    settings: {
      title: "SLP 角色",
      intro: "群组启动时各角色的启动方式。未设置的角色使用编辑器当时显示的提供商、模型和权限模式。",
      launchSection: "启动",
      instructionsSection: "指令",
      thinkingLabel: "思考",
      noThinkingOptions: "此模型没有思考级别",
      bundledRoleLabel: "{{role}} 指令",
      bundledSharedLabel: "共享 SLP 指令",
      bundledAlwaysApplied: "始终应用",
      bundledLoading: "正在加载内置指令…",
      bundledUnavailable: "无法加载内置指令。",
      extraPreview: "额外：{{text}}",
      bundledOnly: "仅内置指令。",
      descriptions: {
        supervisor: "Supervised 模式下的联系人。保持你的意图，向 Lead 布置任务并汇报。",
        lead: "工程负责人。阅读项目、制定计划、委派给 Peer 并验收结果。",
        peer: "来自 Lead 的一项有边界的任务，以 handback 形式交回。",
      },
      defaultWith: "编辑器默认值：{{value}}",
      defaultSummary: "使用编辑器的提供商、模型和权限模式。",
      hasInstructions: "包含额外指令。",
      edit: "编辑",
      reset: "使用编辑器默认值",
      editTitle: "{{role}} 设置",
      instructionsLabel: "额外指令",
      instructionsHint: "附加在该角色的内置指令之后。",
      instructionsPlaceholder: "用中文回答。报告不超过十行。",
      unavailable: "此主机不支持 SLP 群组。",
    },
    banner: {
