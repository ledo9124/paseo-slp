...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/ledo9124/paseo-slp/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Paseo-SLP-${normalizedVersion}-arm64.dmg`;
}
