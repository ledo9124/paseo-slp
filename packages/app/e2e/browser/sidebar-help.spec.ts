...
const GITHUB_ISSUE_DESTINATION =
  /^https:\/\/github\.com\/(?:ledo9124\/paseo-slp\/issues\/new(?:\/choose)?(?:[/?#]|$)|login\?return_to=https%3A%2F%2Fgithub\.com%2Fledo9124%2Fpaseo-slp%2Fissues%2Fnew$)/;
...
const PRODUCT_NAME_PATTERN = PRODUCT_NAME.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
const APP_VERSION = new RegExp(
  `^${PRODUCT_NAME_PATTERN}\\s*v\\d+\\.\\d+\\.\\d+(?:-[0-9A-Za-z.-]+)?(?:\\+[0-9A-Za-z.-]+)?$`,
);
