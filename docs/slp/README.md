...
| [Supervisor-controlled handoff](supervisor-controlled-handoff.md) | The decision boundary a supervised Lead transfer stops at                          |
